...
<public-part
	...
	<caption>Model Folder Tree for compilation</caption>
	<description>Contains all model partitions in [mc, rep, src]</description>
	<entities>
		<entity>
			<name>mc</name>
			<entity-type>Model Folder Tree</entity-type>
		</entity>
		<entity>
			<name>rep</name>
			<entity-type>Model Folder Tree</entity-type>
